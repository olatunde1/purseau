                ...
                <div className="checkout-section border p-6 rounded-md shadow-sm bg-white w-full mt-[60px]">
                    ...
                    <div className="grid gap-4">
                        <div>
                            ...
                            <input
                                type="text" name="name"
                                placeholder="Input your full name" value={formData.name}
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder="example@purseau.com" value={formData.email}
                                onChange={handleChange}
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder="123 Street, Area" value={formData.address}
                                onChange={handleChange}
                                className="border rounded-md p-2 w-full  bg-[#F2F2F7] px-6 py-[20px]"
                            />
                        </div>
