  ...
  export default function TermsAndConditions() {
    ...
    return <>
        ...
        <AccordionItem value="item-2" className="border rounded-lg">
          <AccordionTrigger className="px-6 py-4 hover:bg-gray-50">
            <h2 className="text-lg font-semibold">2. Registration & Account</h2>
          </AccordionTrigger>
          <AccordionContent>
            <div className="px-6 py-4">
              <p className="text-gray-700 mb-4">
        ...
        <AccordionItem value="item-5" className="border rounded-lg">
          <AccordionTrigger className="px-6 py-4 hover:bg-gray-50">
            <h2 className="text-lg font-semibold">5. Delivery</h2>
          </AccordionTrigger>
          <AccordionContent>
            <div className="px-6 py-4">
              <p className="text-gray-700 mb-4">
        ...
        <AccordionItem value="item-6" className="border rounded-lg">
          <AccordionTrigger className="px-6 py-4 hover:bg-gray-50">
            <h2 className="text-lg font-semibold">6. Miscellaneous</h2>
          </AccordionTrigger>
          <AccordionContent>
            <div className="px-6 py-4">
              <p className="text-gray-700 mb-4 leading-relaxed">
        ...
        <AccordionItem value="item-8" className="border rounded-lg">
          <AccordionTrigger className="px-6 py-4 hover:bg-gray-50">
            <h2 className="text-lg font-semibold">8. Use of Website</h2>
          </AccordionTrigger>
          <AccordionContent>
            <div className="px-6 py-4">
              <p className="text-gray-700 mb-4 leading-relaxed">
        ...
        <AccordionItem value="item-9" className="border rounded-lg">
          <AccordionTrigger className="px-6 py-4 hover:bg-gray-50">
            <h2 className="text-lg font-semibold">9. Copyright and Trademarks</h2>
          </AccordionTrigger>
          <AccordionContent>
            <div className="px-6 py-4">
              <p className="text-gray-700 mb-4 leading-relaxed">
        ...
        <AccordionItem value="item-10" className="border rounded-lg">
          ...
          <AccordionContent>
            <div className="px-6 py-4">
              ...
              <p className="text-gray-700 mb-4">
                10.2 Lorem Ipsum is dummy text used throughout the design industry. Lorem Ipsum has been the standard dummy text for many hundreds of years. Ever since an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
              </p>

              <p className="text-gray-700 mb-4">
                10.3 Lorem Ipsum is dummy text used throughout the design industry. Lorem Ipsum has been the standard dummy text for many hundreds of years. Ever since an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
              </p>
              <ul className="list-disc pl-6 text-gray-700 mb-4">
                <li>In a laoreet purus. Integer turpis quam, laoreet id orci nec, ultrices lacinia nunc. Aliquam erat vo</li>
                <li>Ullamcorper morbi tincidunt ornare massa eget. Quam viverra orci sagittis eu volutpat odio facilisis</li>
