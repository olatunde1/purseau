...
export default function SpecialOffer() {
  ...
  return (
    <div className=" p-8 rounded-lg ">
      ...
      <p className="text-lg mb-6">Save up to 50% off our super sale!</p>

      <div className="flex  gap-4">
        {["Hours", "Minutes", "Seconds"].map((label, index) => {
          const value = [timeLeft.hours, timeLeft.minutes, timeLeft.seconds][index];
          return (
            <Button key={label} variant="outline" className="w-20 h-20 flex flex-col items-center justify-center">
