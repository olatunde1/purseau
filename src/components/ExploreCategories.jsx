...
const ExploreCategories = () => {
  return (
    <>
      {/* Desktop view for explore by categories */}
  ...
  >
    ...
    <Link to="/shop?category=clothes" className="w-full">
      <div className="relative group rounded-lg overflow-hidden shadow-md">
        ...
        />
        <span className="absolute bottom-0 w-full bg-black/40 text-white font-semibold text-sm sm:text-base text-center py-1">
          Clothes
        </span>
      </div>
    </Link>
