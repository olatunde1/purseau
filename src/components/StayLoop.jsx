      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="lg:flex lg:flex-row lg:items-center lg:justify-between lg:gap-12">
          ...
          <div className="lg:flex-1 mb-8 lg:mb-0">
            <h3 className=" font-bold text-gray-900 mb-4 stay-in-loop-text">Stay In The Loop!</h3>
            <p className="text-gray-600 text-lg stay-in-loop-text2">
              Be the first to know about our latest arrivals, exclusive deals, <br /> and fashion tips.
            </p>
          </div>
          ...
          <div className="lg:flex-1">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              {/* Subscribe Button */}
              <Button className=" subscribe-button w-full sm:w-auto  text-white font-semibold py-6 px-6 rounded-lg">
                Subscribe
              </Button>
            </div>
            ...
            <div className="mt-6 flex items-center j">
              ...
              />
              <label htmlFor="terms" className="ml-2 text-sm text-gray-600 agreement-check">
              I agree to Purseau’s privacy and policy. You can unsubscribe from newsletter anytime.
              </label>
            </div>
          </div>
        </div>
