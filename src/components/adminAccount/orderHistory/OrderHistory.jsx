                ...
                <td className='py-2 px-4 font-bold cursor-pointer relative'>
                  ...
                  {modalOrder && modalOrder.id === order.id && (
                    <div className="absolute right-0 top-6 z-20 bg-white border rounded shadow p-2 min-w-[178px]">
                      <button
                        className="w-full text-center px-1 py-2 hover:bg-[#FFE4DA] hover:text-[#E94E30] rounded  font-semibold"
                        onClick={() => {
                          setModalOrder(null);
                      ...
                      <button
                        className="w-full text-center px-3 py-2 text-gray-500 hover:text-[#E94E30] hover:bg-gray-100 rounded"
